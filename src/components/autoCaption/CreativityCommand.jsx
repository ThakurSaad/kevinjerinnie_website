...
const CreativityCommand = () => {
  ...
  return (
    <div className="my-20 text-center responsive-base-width ">
      <div className="text-5xl font-bold px-28">
        Creativity at your
        <span className="text-[#327CFE]"> command</span>
      </div>
...
export default CreativityCommand;
