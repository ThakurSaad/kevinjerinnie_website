...
const TextToVideoModels = () => {
  ...
  return (
    <div className="mt-10 text-center responsive-base-width ">
      <div className="text-5xl font-bold ">
        Unleash Your Creativity with the World’s Most Advanced 
        <div className="text-[#327CFE]"> AI Generation</div>
        Models
      </div>
...
export default TextToVideoModels
