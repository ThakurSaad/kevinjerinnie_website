...
import heroimage from "../../assets/kevin videos/platform resizing/top/resizing.png";
import heroBg from "../../assets/herosectionImages/videoclipherobg.png";


const PlatformResizingHero = () => {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
          ...
          <div className="space-y-8">
            ...
            <p className="max-w-lg text-lg leading-relaxed text-slate-600">
              No more one-size-fits-all videos. Our AI-powered platform automatically adapts your content for any platform, audience, or format. From adjusting aspect ratios to adding captions and background music, we make sure your videos always look their best, wherever you share them.
            </p>
...
export default PlatformResizingHero;
